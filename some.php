    ...
    <div class="w3-col l8 s12">
      ...
      <?php if ($stories): ?>
        ...
        <div class="w3-center">
          ...
          <h3><a href="index.php"><?php echo htmlspecialchars($stories['story']); ?></a></h3>


          <h5>Upload On <span class="w3-opacity"><?php echo htmlspecialchars($stories['upload']); ?></span></h5>
        ...
        <div class="w3-justify">
          ...
          <p><?php echo htmlspecialchars($stories['plot']); ?></p>
        ...
        <?php else: ?>
            <?php echo "This id doesn't exist" ?>
